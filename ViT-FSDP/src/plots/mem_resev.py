...
# Real
ddp = [2.9863, 14.2148, 20.2227, 61.5625, 0]
NO_SHARD = [2.8906, 14.8008, 21.2734, 63.2109, 0]
HYBRID = [2.8633, 14.8828, 21.8594, 63.6133, 0]
HYBRID_2GPUs = [1.9961, 7.4902, 10.875, 30.1621, 46.957]
HYBRID_8GPUs = [0, 0, 0, 0, 16.0312]
HYBRID_16GPUs = [0, 0, 0, 0, 11.0742]
